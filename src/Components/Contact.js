                                            ...
                                            <div class="row align-items-center" style={{height: '60vh'}}>
                                                ...
                                                <h3 class="mb-4 display-3">Talk Soon!</h3>
                                                        <ul className="contact-list">
                                                            <li className="my-5"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                                                            <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/>
                                                            </svg> <h6 className="contact-list-item"> &nbsp;mstaton.dev@gmail.com</h6></li>
                                                            <li className="my-5"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-phone-vibrate-fill" viewBox="0 0 16 16">
                                                            ...
                                                            </svg><h6 className="contact-list-item"> &nbsp;843-457-8977</h6></li>
